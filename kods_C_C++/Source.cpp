...
void main(void)
{
	...
	for (int i = 0; i < CARS; i++) //For loop creating the threads according to the number of cars.
	{
		car_thread[i] = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)car_body, (LPVOID)(i + 1), 0, NULL); //	CreateThread 
																										 ...
																										 // Fifth argument specifies whether the thread should begin execution immediately.
																										 //	This argument can have the value 0 or CREATE_SUSPENDED. In this case the argument is 0 meaning the thread runs immediately upon creation.
